...
// enter api-key 
char sendcurl[] = "curl --user apikey:dwf2V8CooxGA_p8wPFmkgY-GVBzcCtBsyhrM2PmC3iYT --request POST --header \"Content-Type: application/json\" --data \"{\\\"text\\\"\:";

// url must be adjusted
char endtext[] = "\\\"\model_id\\\"\:\\\"es-en\\\"\}\"\ \"\https://api.au-syd.speech-to-text.watson.cloud.ibm.com/instances/aab88e11-bf23-47bb-9696-4a9c5cee010a\"";
...
char flitetoend[] = "\" C:\speech to speech";
